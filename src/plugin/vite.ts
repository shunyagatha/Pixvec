 ...
 * vecline's pure-TS core avoids the native-binary CI pain those carry. Returns the
...
export interface VeclinePluginOptions {
...
export function veclinePlugin(options: VeclinePluginOptions = {}): RollupPlugin {
