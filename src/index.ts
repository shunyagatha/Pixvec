/**
 * Vecline — measurable raster ⇄ SVG conversion.
 *
 * This is the **Node entry point**. It re-exports everything from
 * `vecline/core` and adds the parts that need real codecs: reading image files,
 ...
 * not want a native dependency, import `vecline/core` instead. It is the same
...
export { veclinePlugin, type VeclinePluginOptions } from './plugin/vite.js';
